...
let products = [{
    ...
    colors: ["Black", "Blue"],
    sizes: ["UK52", "UK54", "UK56"],
    thumbnail: 'img/model_img_1.jpg',
    preview: ['img/item_slider_img_3.jpg', 'img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg']
}, {
    id: '07cf6ce2-6eee-4e78-a441-f257fdea7ed6',
    dateAdded: '2017-06-12T15:35:13.000Z',
    title: 'Boyfriend T-Shirt with Bohemian print',
    description: 'Featuring fine edging, cascade buttons at the cuffs',
    placeholder: null,
    discountedPrice: 90,
    price: 120,
    hasNew: false,
    ...
    colors: ["Red", "Blue"],
    sizes: ["UK52", "UK54", "UK56"],
    thumbnail: 'img/model_img_2.jpg',
    preview: ['img/item_slider_img_6.jpg', 'img/item_slider_img_3.jpg', 'img/item_slider_img_4.jpg']
}, {
    ...
    colors: ["Black", "Pink"],
    sizes: ["UK52", "UK54"],
    thumbnail: 'img/model_img_3.jpg',
    preview: ['img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg', 'img/item_slider_img_7.jpg']
}, {
    ...
    colors: ["Black", "Blue"],
    sizes: ["UK52", "UK54", "UK54L", "UK56"],
    thumbnail: 'img/model_img_4.jpg',
    preview: ['img/item_slider_img_7.jpg', 'img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg']
}, {
    ...
    colors: ["Black", "Blue"],
    sizes: ["UK52", "UK54", "UK56"],
    thumbnail: 'img/model_img_10.jpg',
    preview: ['img/item_slider_img_7.jpg', 'img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg']
}, {
    ...
    colors: ["Black", "Blue"],
    sizes: ["UK52", "UK54", "UK56"],
    thumbnail: 'img/model_img_11.jpg',
    preview: ['img/item_slider_img_7.jpg', 'img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg']
}, {
    ...
    colors: ["Black", "Blue"],
    sizes: ["UK52", "UK54", "UK56"],
    thumbnail: 'img/model_img_12.jpg',
    preview: ['img/item_slider_img_7.jpg', 'img/item_slider_img_4.jpg', 'img/item_slider_img_5.jpg']
}, {
